...
const ModalMessage = (props) => {
  ...
  const messageModal = isMessage
    ? Constant.MESSAGE_MODAL.your_lose
    : Constant.MESSAGE_MODAL.your_win;
  ...
  return (
    ...
    >
      ...
      <div className="text-center fz15 clr-blue">
        {Constant.MESSAGE_MODAL.new_game} {time}
      </div>
    </Modal>
  );
};
