  ...
  return (
    ...
    <div className="center-screen">
      ...
      <div className="title-game">Đại chiến caro</div>
        <List
          style={{ width: "800px", border: "1px solid #1990ff", overflow:"scroll" }}
          header={<div className="new-room" onClick = {handleCreateRoom}>Mở bàn mới</div>}
          bordered
          dataSource={activeRoom}
          renderItem={(item) => (
            <ListRoomItem item = {item} handleClick = {() => {
